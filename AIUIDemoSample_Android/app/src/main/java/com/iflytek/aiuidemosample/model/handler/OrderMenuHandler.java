...
public class OrderMenuHandler extends Handler {
    ...
    public boolean urlClicked(String url) {
        String menuSrcData = "";
        if(url.equals("001")){
            menuSrcData = readAssetFile("data/001_branch_menu.txt");
        }else if(url.equals("002")){
            menuSrcData = readAssetFile("data/002_branch_menu.txt");
        }
        ...
        MessagesViewModel.getInstance().putPersParam("branch", url);
    ...
    private String readAssetFile(String filename){
        try {
            ...
            InputStream input = MessagesViewModel.getInstance().getContext().
